...
export function EditorPlayground() {
  ...
  const notes = useMemo(
    () => [
      "This page mounts the headless markora core with the optional markora-ui overlays.",
      "Use the source panel to exercise setMarkdown() plus flushChange() against the live editor.",
      "The output panel shows the exact serialized Markdown emitted from editor state.",
    ],
    [],
  );
    ...
    <div className="playground-shell">
      <div className="playground-intro">
        <div>
          ...
          <h1>Test the headless core in a realistic host shell.</h1>
          <p>
            This playground mounts <code>markora</code> with optional <code>markora-ui</code> overlays,
            updates the host with <code>onChangeMode: "animationFrame"</code>, and shows both Markdown-in
            and Markdown-out behavior side by side.
          </p>
        </div>
      ...
      <div className="playground-layout">
        <section className="panel panel-editor">
          <div className="panel-header">
            <h3>Visual editor</h3>
            <p>Use the toolbar or type directly into the mounted editor instance.</p>
          </div>
        ...
        <section className="panel panel-source">
          <div className="panel-header">
            ...
            <p>Edit raw Markdown, then apply it through <code>editor.commands.setMarkdown()</code>.</p>
          </div>
      ...
      <section className="panel panel-output">
        <div className="panel-header">
          ...
          <p>Inspect the <code>onChange</code> output and verify round-tripping behavior.</p>
        </div>
